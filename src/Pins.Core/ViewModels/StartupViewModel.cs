...
using Pins.Core.Models;

namespace Pins.Core.ViewModels
{
    public class StartupViewModel : MvxViewModel
    {
        ...
        public string ParatextProjectPath
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(() => ParatextProjectPath);
            }
        }
        ...
        public int ProjectSelectedId
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(() => ProjectSelectedId);
            }
        }
        ...
        public List<tabledt> TheData
        {
            ...
            {
                _thedata = value;
                RaisePropertyChanged(() => TheData);
            }
        }

        private string _TimerEnd = "";
        ...
        public IMvxCommand FilterCommand { get; set; }
        public IMvxAsyncCommand LoadRefsCommandAsyncCommand { get; set; }
        ...
        public StartupViewModel(IMvxNavigationService navigationService)
        {
            ...
            FilterCommand = new MvxCommand(ClearFiterTerms);
            LoadRefsCommandAsyncCommand = new MvxAsyncCommand(FetchRefs);
        }
        ...
        {
            Debug.WriteLine("ViewAppeared");

            ParatextUtils pt = new ParatextUtils();
            if (await pt.IsParatextInstalledAsync().ConfigureAwait(false))
            {
                _paratextInstallPath = pt.paratextInstallPath;
                ParatextProjectPath = pt.paratextProjectPath;
            }
        ...
        private void LoadLexemes(string projectName) // Mother lexicon for project
        {
            ...
            RaisePropertyChanged(() => GridCollectionView);
        }
        ...
        {
            // DataListView.DataSource = thedata;
            // use only for Grid set up... not refresh
            //Grid.DataSource = thedata;
            //Grid.ContextMenuStrip = gridMenu0;
            //Grid.AlternatingRowsDefaultCellStyle.BackColor = Color.AntiqueWhite;
            //Grid.RowHeadersVisible = false;

            //Grid.Columns["Source"].HeaderText = "Lexeme";             // [0]  lexeme
            //Grid.Columns["Source"].ReadOnly = true;
            //Grid.Columns["Source"].ContextMenuStrip = gridMenu0;
            //Grid.Columns["Source"].DisplayIndex = 0;
            //// Grid.Columns["Source"].Frozen = true; 
            //Grid.Columns["Lform"].HeaderText = "Forms";             // [1]  form (word stem prefix suffix)
            //Grid.Columns["Lform"].ReadOnly = true;
            //Grid.Columns["Lform"].Width = 65;
            //Grid.Columns["Lform"].Visible = chk_ShowType.Checked;
            //Grid.Columns["Lform"].DisplayIndex = 1;
            //Grid.Columns["Gloss"].Visible = true;                   // [2]  gloss
            //Grid.Columns["Gloss"].ReadOnly = true;
            //Grid.Columns["Gloss"].DisplayIndex = 2;
            //Grid.Columns["Lang"].Visible = chk_ShowLang.Checked;    // [3]  gloss language
            //Grid.Columns["Lang"].ReadOnly = true;
            //Grid.Columns["Lang"].DisplayIndex = 3;
            //Grid.Columns["Refs"].Visible = false;                   // [4]  full references
            //Grid.Columns["Refs"].ReadOnly = true;
            //Grid.Columns["Refs"].DisplayIndex = 4;
            //Grid.Columns["Code"].Visible = chk_ShowCode.Checked;    // [5]  Paratext lexeme ID
            //Grid.Columns["Code"].ReadOnly = true;
            //Grid.Columns["Code"].DisplayIndex = 5;
            //Grid.Columns["Match"].Visible = false;                  // [6]  key: Code+Source
            //Grid.Columns["Match"].ReadOnly = true;
            //Grid.Columns["Match"].DisplayIndex = 6;
            //Grid.Columns["Notes"].Width = 300;                      // [7]  notes
            //Grid.Columns["Notes"].ReadOnly = false;
            //Grid.Columns["Notes"].DefaultCellStyle.WrapMode = DataGridViewTriState.True;
            //Grid.Columns["Notes"].DisplayIndex = 7;
            //Grid.Columns["SimpRefs"].Width = 300;                   // [8]  simplified references
            //Grid.Columns["SimpRefs"].ReadOnly = true;
            ////            Grid.Columns["SimpRefs"].DefaultCellStyle.WrapMode = DataGridViewTriState.True;
            //Grid.Columns["SimpRefs"].DisplayIndex = 8;
            //Grid.Columns["Phrase"].ReadOnly = true;
            //Grid.Columns["Phrase"].HeaderText = "";
            //Grid.Columns["Phrase"].Width = 55;
            //Grid.Columns["Phrase"].DisplayIndex = 9;
            //Grid.Columns["Word"].ReadOnly = true;
            //Grid.Columns["Word"].HeaderText = "";
            //Grid.Columns["Word"].Width = 35;
            //Grid.Columns["Word"].DisplayIndex = 10;
            //Grid.Columns["Prefix"].ReadOnly = true;
            //Grid.Columns["Prefix"].HeaderText = "";
            //Grid.Columns["Prefix"].Width = 35;
            //Grid.Columns["Prefix"].DisplayIndex = 11;
            //Grid.Columns["Stem"].ReadOnly = true;
            //Grid.Columns["Stem"].HeaderText = "";
            //Grid.Columns["Stem"].Width = 41;
            //Grid.Columns["Stem"].DisplayIndex = 12;
            //Grid.Columns["Suffix"].ReadOnly = true;
            //Grid.Columns["Suffix"].HeaderText = "";
            //Grid.Columns["Suffix"].Width = 33;
            //Grid.Columns["Suffix"].DisplayIndex = 13;

            //_worker.RunWorkerAsync();   // Autosize columns
            //Grid.AutoResizeRows();
            //Grid.Refresh();
        }
        ...
        private async Task FetchRefs()
        {
            ...
            var seconds = Math.Round(ts.TotalSeconds, 2);
            TimerEnd = seconds.ToString();
        }
